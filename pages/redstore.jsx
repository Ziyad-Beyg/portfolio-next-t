...
import redstoreImg from '../public/assets/projects/redstore.png';
    ...
    <div className='w-full'>
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8'>
        <div className='col-span-4'>
          ...
          <a
            href='https://github.com/Ziyad-Beyg/Practice-Redstore-Website'
            target='_blank'
            rel='noreferrer'
          >
          ...
          <a
            href='https://ziyad-beyg.github.io/Practice-Redstore-Website/'
            target='_blank'
            rel='noreferrer'
          >
          ...
          <div className='p-2'>
            ...
            <div className='grid grid-cols-3 md:grid-cols-1 '>
              <p className='text-gray-600 py-2 flex items-center'>
                <RiRadioButtonFill className='pr-1 mx-3' /> HTML
              </p>
              <p className='text-gray-600 py-2 flex items-center'>
                <RiRadioButtonFill className='pr-1 mx-3' /> CSS
              </p>
              <p className='text-gray-600 py-2 flex items-center'>
