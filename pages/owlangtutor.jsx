...
import owlangTutorImage from '../public/assets/projects/Owlang-tutor.PNG';
    ...
    <div className='w-full'>
      <div className='w-screen h-[50vh] relative'>
        ...
        <Image
          ...
          layout='fill'
          objectFit='cover'
          src={owlangTutorImage}
          alt='/'
        />
        <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
          <h2 className='py-2'>Owlang Tutor</h2>
          <h3>HTML / CSS </h3>
        </div>
      </div>
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8'>
        <div className='col-span-4'>
          ...
          <a
            href='https://ziyad-beyg.github.io/ZIYAD-BEYG-OWLANGTUTOR/'
            target='_blank'
            rel='noreferrer'
          >
          ...
          <a
            href='https://github.com/Ziyad-Beyg/ZIYAD-BEYG-OWLANGTUTOR'
            target='_blank'
            rel='noreferrer'
          >
